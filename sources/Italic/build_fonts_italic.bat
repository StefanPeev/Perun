...
python3 -m fontmake -i -a -o ttf -m Perun-Italic.designspace
python3 -m fontmake -i -a -o otf -m Perun-Italic.designspace
python3 -m fontmake -a -o variable -m Perun-Italic.designspace
...
python fix-dsig.py .\autohinted\instance_ttf\Perun-Italic.ttf |
...
python fix-dsig.py .\instance_otf\Perun-Italic.otf |
...
move .\variable_ttf\Perun-VF.ttf ..\fonts\vf\Perun-Italic[wght].ttf
